    ...
    if btn_form:
        if not nome or not telefone or not email or horas_sol == 0 or tamanho_jardim == 0:
            ...
            if horas_sol > 6 and tamanho_jardim >= 100:
                ...
                st.write("Para seu jardim com pelo menos 6 horas de sol por dia, algumas plantas que você pode considerar são: plantas como cenoura, alho e aspargos")
            elif horas_sol >= 6 and tamanho_jardim < 100:
                st.write("Para seu jardim com pelo menos 6 horas de sol por dia, algumas plantas que você pode considerar são: plantas como salsa, couve flor, alface e rúcula")
            else:
