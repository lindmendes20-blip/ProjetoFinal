...
<body>
        ...
        <header style="display:flex;justify-content:space-between;">
            <nav style="display:flex;justify-content:space-between;color:#E9F9B2;gap:2px;">
                <ul style="display:flex;justify-content:space-between;gap:2rem;align-items:center;margin:2rem;font-size:1.5em;list-style:none;">
					...
					<li><a href="#" style="color:#E9F9B2;text-decoration-line:none;">Calculadora</a></li>
                </ul>
            </nav>
        </header>
    </div>
    <div style="background-color:#E9F9B2;">
        <h1 style="font-size:3rem;text-align:center;text-transform:uppercase;color:#425C00; margin-top: 0rem;">A importância da luz para as plantas</h1>
	<p style="font-size:1.5rem;text-align:justify;color:#425C00;margin:2rem;">
        ...
        <p style="font-size:1.5rem;text-align:justify;color:#425C00;margin:2rem; margin-bottom: 0rem;">
